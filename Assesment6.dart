...
import 'package:pd2_app/Assesment7.dart';

class Assesment6 extends StatelessWidget {
  const Assesment6({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const Assesment7()));
              },
              child: Container(
