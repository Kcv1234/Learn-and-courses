...
import 'package:pd2_app/Development3.dart';
import 'package:pd2_app/Home_screen.dart';
import 'package:pd2_app/Search.dart';

class DataScience3 extends StatelessWidget {
  const DataScience3({Key? key}) : super(key: key);
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    _buildCategoryButton(context, 'Data Science', true ),
                    _buildCategoryButton(context, 'Designs', false, Design3()),
                    _buildCategoryButton(context, 'Development', false, Development3()),
