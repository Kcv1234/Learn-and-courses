...
import 'package:pd2_app/Assesment6.dart';


class Assesment5 extends StatelessWidget {
  const Assesment5({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const Assesment6()));
              },
              child: Container(
