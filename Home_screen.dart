    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: _customText(
                'Search for a Course or Mentor', 12, const Color(0xFFABABAB)),
          ),
          Container(
  ...
  Widget _headerRow(String title, BuildContext context, Widget actionPage) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          _customText(title, 15, const Color(0xFF414ECA),
              fontWeight: FontWeight.w700),
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => actionPage));
            },
